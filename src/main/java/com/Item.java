...
public class Item {
	private Connection connect() {
		...
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/bill", "root", "root");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return con;
	...
	public String readItems() {
		...
		try {
			...
			output = "<table border='1'><tr><th>Date</th><th>Time Period</th><th>Unit Price</th>"
					+ "<th>Total Price</th><th>Update</th><th>Remove</th></tr>";
